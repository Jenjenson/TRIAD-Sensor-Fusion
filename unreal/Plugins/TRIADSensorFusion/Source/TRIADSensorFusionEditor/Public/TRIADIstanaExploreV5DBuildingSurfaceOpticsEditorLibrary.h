...
#include "TRIADIstanaExploreV5DBuildingSurfaceOpticsEditorLibrary.generated.h"

/**
 * Editor-only, unnumbered, fail-closed receipt-inspection boundary for
 * BuildingSurfaceOpticsCandidate. The only reflected endpoint is read-only
...
class TRIADSENSORFUSIONEDITOR_API
    UTRIADIstanaExploreV5DBuildingSurfaceOpticsEditorLibrary
...
public:
    ...
    static bool InspectBuildingSurfaceOpticsReceipts(
