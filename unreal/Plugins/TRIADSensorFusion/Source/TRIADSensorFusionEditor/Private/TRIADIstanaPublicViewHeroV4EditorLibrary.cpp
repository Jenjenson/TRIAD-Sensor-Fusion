...
const FString SourceMapPackage(TEXT("/Game/Maps/Istana_PublicView_Exterior_v3"));
const FString DestinationMapPackage(TEXT("/Game/Maps/Istana_PublicView_Exterior_v4"));
...
const FString HeroAssetRoot(TEXT("/Game/TRIAD/IstanaPublicViewV4"));
const FString HeroMeshPath(TEXT("/Game/TRIAD/IstanaPublicViewV4/Building"));
const FString HeroMeshName(TEXT("SM_IstanaPublicViewV4_Building_Hero"));
...
const FString V3HeroMeshObjectPath(
...
const FString MaterialAssetRoot(
    TEXT("/Game/TRIAD/IstanaPublicView/HeroMaterialsV4"));
const FString MaterialTexturePath(
    TEXT("/Game/TRIAD/IstanaPublicView/HeroMaterialsV3/Textures"));
const FString GeometrySourceRoot(TEXT("SourceAssets/IstanaPublicViewV4"));
const FString GeometryContractRelativePath(
    TEXT("SourceAssets/IstanaPublicViewV4/istana_public_view_hero_v4.contract.json"));
const FString GeometryManifestRelativePath(
    TEXT("SourceAssets/IstanaPublicViewV4/Generated/IstanaPublicViewV4Building.manifest.json"));
const FString GeometryObjRelativePath(
    TEXT("SourceAssets/IstanaPublicViewV4/Generated/SM_IstanaPublicViewV4_Building_Hero.obj"));
const FString GeometryFreezeRelativePath(
    TEXT("SourceAssets/IstanaPublicViewV4/hero_v4.freeze.json"));
const FString GeometryGeneratorRelativePath(
    TEXT("SourceAssets/IstanaPublicViewV4/generate_hero_v4.py"));
const FString GeometryClosureAuditRelativePath(
    TEXT("SourceAssets/IstanaPublicViewV4/central_closure_audit.py"));
...
const FString GeometryWindingAuditRelativePath(
    TEXT("SourceAssets/IstanaPublicViewV4/v4_winding_audit.py"));
const FString FreezeRelativePath(
    TEXT("Plugins/TRIADSensorFusion/Resources/IstanaPublicViewHeroV4.integration.freeze.json"));
const FString MaterialSourceRoot(
    TEXT("SourceAssets/IstanaPublicView/HeroMaterialsV4"));
...
const FString MaterialContractRelativePath(
    TEXT("SourceAssets/IstanaPublicView/HeroMaterialsV4/hero_materials_v4.contract.json"));
const FString MaterialInterfaceRelativePath(
    TEXT("SourceAssets/IstanaPublicView/HeroMaterialsV4/unreal_asset_interface.v4.json"));
const FString MaterialFreezeRelativePath(
    TEXT("SourceAssets/IstanaPublicView/HeroMaterialsV4/hero_materials_v4.freeze.json"));
...
const FString FrozenFreezeSha256(
    TEXT("c6afedad2ca868be455a5425ab02114fb1584d237700c9fba489b595be650f12"));
const FString FrozenGeometryFreezeSha256(
    TEXT("c31cc1b81d4a7008f69ad84c72795244ef9bc4daf12e29d4ee181bde3f1f75cd"));
const FString FrozenGeometryContractSha256(
    TEXT("2578edcb30c122f15a357ae604fa9ab6d8a95c457255cfafe27dd05c69827822"));
const FString FrozenGeometryGeneratorSha256(
    TEXT("65911bd06fa4d09331c048f9c778c1650d6f32736f94981f36dd6974d1498b6d"));
const FString FrozenGeometryManifestSha256(
    TEXT("7277aad39e33208ea4ccd5dd848ac8f2ddffef5ab903a44f22854dee77e77b51"));
const FString FrozenGeometryManifestSemanticSha256(
    TEXT("e56c627bf40588ebcef74fb17d4a9a8c35339c8bd2addcc3bac4959f91c0b842"));
const FString FrozenGeometryObjSha256(
    TEXT("6bd4caba97ae9b559303c5cf0192ecfd4962921acfe72c106a2e304fb37bd076"));
...
const FString FrozenMaterialContractSha256(
    TEXT("3251b58a8d3c87cf7c41e520a3bc331ef5e04cd399b327bc35c9c9ba376f96cb"));
const FString FrozenMaterialInterfaceSha256(
    TEXT("80dfc9bf36cf6419e0512c3cf49b0f310669a94c6325389a1ba971f22329493e"));
const FString FrozenMaterialFreezeSha256(
    TEXT("2459254b4835c0aff123028feb4ed09fe6282bf8cbe07901b4813e89d85300a7"));
...
const FString FrozenGeometryClosureAuditSha256(
    TEXT("691c25144f501bde381ff052afe188aeca44c878df389f8eac6ae5c9f09fecd3"));
...
const FString FrozenGeometryWindingAuditSha256(
    TEXT("063be95d22f540e67923ed72794a3463e2c7ffece853cfbeea089e69a58f87c3"));
...
// Populated from the independently reviewed V4 geometry freeze only. Zero is
// deliberately non-runnable and is additionally gated by the pending digests.
constexpr int32 ExpectedHeroTriangles = 958836;
constexpr int32 ExpectedHeroVertices = 2876508;
...
bool HasExactV3ToV4SlotMapping(
    const TArray<FString>& V3Slots,
    const TArray<FString>& V4Slots)
{
    if (V3Slots.Num() != V4Slots.Num())
    {
        return false;
    }
    TSet<FString> ExpectedV4;
    for (const FString& V3Slot : V3Slots)
    {
        ...
        ExpectedV4.Add(
            FString(TEXT("M_IPV4_")) + V3Slot.RightChop(7));
    }
    TSet<FString> ActualV4;
    for (const FString& V4Slot : V4Slots)
    {
        ActualV4.Add(V4Slot);
    }
    return ExpectedV4.Num() == V4Slots.Num() &&
        ActualV4.Num() == V4Slots.Num() &&
        ExpectedV4.Includes(ActualV4);
}
...
bool ValidateHeroV4VisualAcceptanceProcessProfile(FString& OutReport)
{
    ...
    {
        OutReport = TEXT("Hero-V4 PIE requires exactly one -TRIADIstanaVisualAcceptance flag and exactly one canonical -settings argument.");
        return false;
    }
    ...
    if (!FPaths::IsSamePath(ExpectedSettings, ActualSettings))
    {
        OutReport = FString::Printf(
            TEXT("Hero-V4 PIE settings path is '%s', expected exact project-owned '%s'."),
            *ActualSettings,
            *ExpectedSettings);
        return false;
    }
    ...
    {
        OutReport = TEXT("Hero-V4 PIE requires the exact 1022-byte repository-owned shared V3/V4 no-lidar/RPC-off settings profile. ") + Error;
        return false;
    }
    ...
    {
        OutReport = TEXT("Hero-V4 PIE no-lidar/RPC-off settings contract failed; both upstream RpcEnabled=false and deployed-AirSim-1.8.1 EnableRpc=false must occur exactly once, with loopback API address. ") + Error;
        return false;
    }
    ...
    {
        OutReport = TEXT("Hero-V4 PIE requires one auto-created ComputerVision vehicle with an empty Sensors object. ") + Error;
        return false;
    }
    OutReport = FString::Printf(
        TEXT("Verified exact shared V3/V4 no-lidar/RPC-off process file and command line (%s): upstream RpcEnabled=false plus deployed-AirSim-1.8.1 EnableRpc=false. Direct AirSim RPC state is not introspected across the plugin module boundary."),
        *Digest);
    return true;
}
...
bool ValidateIntegrationFreeze(FString& OutReport)
{
    ...
    {
        OutReport = TEXT("V4_FREEZE_NOT_FROZEN: final closure-audited geometry and material artifacts have not both been bound.");
        return false;
    }
    ...
    {
        OutReport = TEXT("V4_FREEZE_MISSING: ") + Error;
        return false;
    }
    if (Digest != FrozenFreezeSha256)
    {
        OutReport = FString::Printf(
            TEXT("V4_FREEZE_INVALID: integration freeze SHA-256 is %s, expected %s."),
            *Digest,
            *FrozenFreezeSha256);
        return false;
    }
    TSharedPtr<FJsonObject> Freeze;
    int64 CreatedV4TexturePackageCount = -1;
    if (!LoadJsonObject(FreezePath, Freeze, Error) ||
        !ReadExactString(
            Freeze,
            TEXT("schema"),
            TEXT("triad.istana_public_view_hero_v4.unreal_freeze.v1"),
            Error) ||
        !ReadExactString(
            Freeze,
            TEXT("heroAssetRoot"),
        ...
        !ReadInteger(
            Freeze,
            TEXT("createdV4TexturePackageCount"),
            CreatedV4TexturePackageCount,
            Error) ||
        CreatedV4TexturePackageCount != 0 ||
        !ReadExactBool(
            Freeze,
            TEXT("preservesV1V2V3Bytes"),
            true,
            Error) ||
        ...
        !ReadExactBool(
            ...
            Error))
    {
        OutReport = TEXT("V4_FREEZE_INVALID: ") + Error;
        return false;
    }
    ...
    {
        OutReport = TEXT("V4_FREEZE_INVALID: files/protectedV1Files are absent.");
        return false;
    }
    ...
    const TMap<FString, FString> ExpectedRolePaths = {
        {TEXT("GEOMETRY_FREEZE"), TEXT("SourceAssets/IstanaPublicViewV4/hero_v4.freeze.json")},
        {TEXT("GEOMETRY_CONTRACT"), TEXT("SourceAssets/IstanaPublicViewV4/istana_public_view_hero_v4.contract.json")},
        {TEXT("GEOMETRY_GENERATOR"), TEXT("SourceAssets/IstanaPublicViewV4/generate_hero_v4.py")},
        {TEXT("GEOMETRY_CLOSURE_AUDIT"), TEXT("SourceAssets/IstanaPublicViewV4/central_closure_audit.py")},
        {TEXT("GEOMETRY_DENSE_CLOSURE_AUDIT"), TEXT("SourceAssets/IstanaPublicViewV3/dense_facade_closure_audit.py")},
        {TEXT("GEOMETRY_WINDING_AUDIT"), TEXT("SourceAssets/IstanaPublicViewV4/v4_winding_audit.py")},
        {TEXT("GEOMETRY_MANIFEST"), TEXT("SourceAssets/IstanaPublicViewV4/Generated/IstanaPublicViewV4Building.manifest.json")},
        {TEXT("BUILDING_HERO_VISUAL_V4"), TEXT("SourceAssets/IstanaPublicViewV4/Generated/SM_IstanaPublicViewV4_Building_Hero.obj")},
        {TEXT("HERO_MATERIAL_FREEZE"), TEXT("SourceAssets/IstanaPublicView/HeroMaterialsV4/hero_materials_v4.freeze.json")},
        {TEXT("HERO_MATERIAL_CONTRACT"), TEXT("SourceAssets/IstanaPublicView/HeroMaterialsV4/hero_materials_v4.contract.json")},
        {TEXT("HERO_MATERIAL_UNREAL_INTERFACE"), TEXT("SourceAssets/IstanaPublicView/HeroMaterialsV4/unreal_asset_interface.v4.json")},
        ...
        {TEXT("HERO_V3_V4_VISUAL_ACCEPTANCE_SETTINGS"), VisualAcceptanceSettingsRelativePath},
    ...
    {
        OutReport = FString::Printf(
            TEXT("V4_FREEZE_INVALID: exact role roster changed (%d records, expected %d)."),
            RolePaths.Num(),
    ...
    for (const TPair<FString, FString>& Expected : ExpectedRolePaths)
    {
        ...
        {
            OutReport = FString::Printf(
                TEXT("V4_FREEZE_INVALID: role '%s' is absent or bound to a different path."),
                *Expected.Key);
            return false;
        }
    }
    ...
    FString& OutReport)
{
    ...
    {
        OutReport = TEXT("V4_GEOMETRY_NOT_FROZEN: regenerated closure- and outward-winding-audited geometry has not been bound.");
        return false;
    }
    FString Error;
    ...
    if (!ValidateFrozenFile(
        ...
        !ReadExactString(
            Contract,
            TEXT("schema"),
            TEXT("triad.istana_public_view_hero_contract.v4"),
            Error) ||
        !ReadExactString(
            Manifest,
            TEXT("schema"),
            TEXT("triad.istana_public_view_building_manifest.v4"),
            Error) ||
        !ReadExactString(
            GeometryFreeze,
            TEXT("schema"),
            TEXT("triad.istana_public_view_hero_freeze.v4"),
            Error))
    {
        OutReport = TEXT("V4_GEOMETRY_CONTRACT_INVALID: ") + Error;
        return false;
    }
    ...
    const TSharedPtr<FJsonObject>* MaterialInterface = nullptr;
    const TSharedPtr<FJsonObject>* RequiredGeometry = nullptr;
    const TSharedPtr<FJsonObject>* BaselinePreservation = nullptr;
    if (!Contract->TryGetObjectField(TEXT("scope"), Scope) || !Scope ||
        ...
        !Contract->TryGetObjectField(TEXT("materialInterface"), MaterialInterface) ||
        !MaterialInterface || !(*MaterialInterface).IsValid() ||
        !Contract->TryGetObjectField(TEXT("requiredGeometry"), RequiredGeometry) ||
        !RequiredGeometry || !(*RequiredGeometry).IsValid() ||
        !Manifest->TryGetObjectField(
            TEXT("baselinePreservation"), BaselinePreservation) ||
        !BaselinePreservation || !(*BaselinePreservation).IsValid() ||
        !ReadExactBool(*Scope, TEXT("heroBuildingVisualOnly"), true, Error) ||
        !ReadExactBool(*Scope, TEXT("replacesHeroVisualOnly"), true, Error) ||
        !ReadExactBool(*Scope, TEXT("preservesPublicViewV1V2V3Bytes"), true, Error) ||
        ...
        !ReadExactBool(
            *Scope,
            TEXT("limitsNearBlackRecessToV4AuthoredTerminalSeamsAcrossHero"),
            true,
            Error) ||
        !ReadExactBool(
            *Scope,
            TEXT("reclassifiesPreservedV3BroadRecessSupportToV4Render"),
            true,
            Error) ||
        !ReadExactBool(
            *Scope,
            TEXT("reusesFrozenV3TexturePayloadInPlace"),
            true,
            Error) ||
        !ReadExactBool(*Scope, TEXT("changesFrozenV3TextureBytes"), false, Error) ||
        ...
        !ReadExactString(
            *MaterialInterface,
            TEXT("preservedBroadV3RecessSupportTarget"),
            TEXT("M_IPV4_Render"),
            Error) ||
        !ReadExactBool(
            *MaterialInterface,
            TEXT("nearBlackV4RecessExclusiveToAuthoredTerminalSeams"),
            true,
            Error) ||
        !ReadExactString(
            *QualityGateSourceBytes,
            TEXT("central_closure_audit.py"),
        ...
        !ReadExactString(
            *QualityGateSourceBytes,
            TEXT("v4_winding_audit.py"),
            *FrozenGeometryWindingAuditSha256,
            Error) ||
        !ReadExactString(
            Manifest,
            TEXT("centralClosureAuditSha256"),
            *FrozenGeometryClosureAuditSha256,
            Error) ||
        !ReadExactString(
            Manifest,
        ...
        !ReadExactBool(
            *DetailMetrics,
            TEXT("v3DenseClosureAuditPassed"),
            true,
            Error) ||
        !ReadExactBool(
            *DetailMetrics,
            TEXT("v4CentralDenseClosureAuditPassed"),
            true,
            Error) ||
        !ReadExactBool(
            *DetailMetrics,
            TEXT("v4LogicalAndUE55WindingAuditPassed"),
            true,
            Error) ||
        !ReadExactBool(
            *DetailMetrics,
            TEXT("preservedV3BroadRecessSupportReclassifiedToRender"),
            true,
            Error) ||
        !ReadExactBool(
            *DetailMetrics,
            TEXT("openingSizedNearBlackBackingPresent"),
            false,
            Error) ||
        !ReadExactString(
            *DetailMetrics,
            TEXT("heroWideNearBlackRecessPolicy"),
            TEXT("V4_AUTHORED_NARROW_TERMINAL_JOINERY_SEAMS_ONLY"),
            Error))
    {
        OutReport = TEXT("V4_GEOMETRY_CONTRACT_INVALID: hero-only/no-Nanite scope changed. ") + Error;
        return false;
    }
    int64 SparseProbeCount = 0;
    int64 DenseReviewProbeCount = 0;
    int64 DensePhaseProbeCount = 0;
    int64 V3DenseProbeCount = 0;
    int64 CentralProbeCount = 0;
    int64 CentralMissCount = 0;
    int64 RoofWindingTriangleCount = 0;
    int64 VisibleWindingTriangleCount = 0;
    int64 RecessTriangleCount = 0;
    int64 BroadRecessGroupCount = 0;
    int64 BroadRecessTriangleCount = 0;
    int64 TerminalRecessGroupCount = 0;
    int64 HelperV3RecessTriangleCount = 0;
    ...
    if (!ReadInteger(
            *FeatureCounts,
            TEXT("systematicFacadeClosureRayProbes"),
            SparseProbeCount,
            Error) ||
        SparseProbeCount != 1690 ||
        !ReadInteger(
            *FeatureCounts,
            TEXT("independentDenseReviewFacadeClosureRayProbes"),
            DenseReviewProbeCount,
            Error) ||
        DenseReviewProbeCount != 24078 ||
        !ReadInteger(
            *FeatureCounts,
            TEXT("phaseOffsetDenseFacadeClosureRayProbes"),
            DensePhaseProbeCount,
            Error) ||
        DensePhaseProbeCount != 18232 ||
        !ReadInteger(
            *DetailMetrics,
            TEXT("v3DenseClosureProbeCount"),
            V3DenseProbeCount,
            Error) ||
        V3DenseProbeCount != 42310 ||
        !ReadInteger(
            *DetailMetrics,
            TEXT("v4CentralDenseClosureProbeCount"),
            CentralProbeCount,
            Error) ||
        CentralProbeCount != 12359 ||
        !ReadInteger(
            *DetailMetrics,
            TEXT("v4CentralDenseClosureMissCount"),
            CentralMissCount,
            Error) ||
        CentralMissCount != 0 ||
        !ReadInteger(
            *FeatureCounts,
            TEXT("v4RoofWindingTrianglesAudited"),
            RoofWindingTriangleCount,
            Error) ||
        RoofWindingTriangleCount != 4800 ||
        !ReadInteger(
            *FeatureCounts,
            TEXT("v4VisibleFrontWindingTrianglesAudited"),
            VisibleWindingTriangleCount,
            Error) ||
        VisibleWindingTriangleCount != 1104 ||
        !ReadInteger(
            *FeatureCounts,
            TEXT("v4RecessTrianglesAreaAndExtentAudited"),
            RecessTriangleCount,
            Error) ||
        RecessTriangleCount != 468 ||
        !ReadInteger(
            *FeatureCounts,
            TEXT("preservedV3BroadRecessGroupsReclassified"),
            BroadRecessGroupCount,
            Error) ||
        BroadRecessGroupCount != 531 ||
        !ReadInteger(
            *FeatureCounts,
            TEXT("preservedV3BroadRecessTrianglesReclassified"),
            BroadRecessTriangleCount,
            Error) ||
        BroadRecessTriangleCount != 6372 ||
        !ReadInteger(
            *FeatureCounts,
            TEXT("v4TerminalRecessSeams"),
            TerminalRecessGroupCount,
            Error) ||
        TerminalRecessGroupCount != 39 ||
        !ReadInteger(
            *FeatureCounts,
            TEXT("v4HelperV3RecessTrianglesEmitted"),
            HelperV3RecessTriangleCount,
            Error) ||
        HelperV3RecessTriangleCount != 0 ||
        !CalculateSha256(
        ...
        WindingAuditBytes <= 0)
    {
        OutReport = TEXT("V4_GEOMETRY_CONTRACT_INVALID: a sparse/dense façade-closure or slate-winding gate is absent or stale. ") + Error;
        return false;
    }
    ...
    if (!ReadExactString(
            GeometryFreeze,
            TEXT("freezeStatus"),
            TEXT("FROZEN_AFTER_INDEPENDENT_REVIEW_DUAL_BYTE_DETERMINISM_EXACT_RECESS_SEMANTIC_CENSUS_DENSE_CLOSURE_DORMER_CLEARANCE_AND_LOGICAL_UE55_WINDING_ZERO_FAILURES"),
            Error) ||
        !ReadExactString(
            GeometryFreeze,
            TEXT("contractSha256"),
    ...
    {
        OutReport = TEXT("V4_GEOMETRY_FREEZE_INVALID: exact reviewed freeze binding changed. ") + Error;
        return false;
    }

    int64 RequiredBroadGroups = 0;
    int64 RequiredBroadTriangles = 0;
    int64 RequiredTerminalSeams = 0;
    int64 RequiredRecessTriangles = 0;
    int64 RequiredHelperRecessTriangles = 0;
    const TSharedPtr<FJsonObject>* RecessCorrection = nullptr;
    const TSharedPtr<FJsonObject>* RecessSuffixCounts = nullptr;
    int64 CorrectionGroups = 0;
    int64 CorrectionTriangles = 0;
    int64 UnknownGroups = 0;
    int64 DarkRevealGroups = 0;
    int64 SealedGroups = 0;
    int64 LouvreRecessGroups = 0;
    int64 BackingGroups = 0;
    if (!ReadInteger(
            *RequiredGeometry,
            TEXT("preservedV3BroadRecessGroupsReclassified"),
            RequiredBroadGroups,
            Error) ||
        RequiredBroadGroups != 531 ||
        !ReadInteger(
            *RequiredGeometry,
            TEXT("preservedV3BroadRecessTrianglesReclassified"),
            RequiredBroadTriangles,
            Error) ||
        RequiredBroadTriangles != 6372 ||
        !ReadInteger(
            *RequiredGeometry,
            TEXT("terminalRecessSeams"),
            RequiredTerminalSeams,
            Error) ||
        RequiredTerminalSeams != 39 ||
        !ReadInteger(
            *RequiredGeometry,
            TEXT("recessTrianglesAreaAndExtentAudited"),
            RequiredRecessTriangles,
            Error) ||
        RequiredRecessTriangles != 468 ||
        !ReadInteger(
            *RequiredGeometry,
            TEXT("v4HelperV3RecessTrianglesEmitted"),
            RequiredHelperRecessTriangles,
            Error) ||
        RequiredHelperRecessTriangles != 0 ||
        !(*BaselinePreservation)->TryGetObjectField(
            TEXT("preservedV3BroadRecessSemanticCorrection"),
            RecessCorrection) ||
        !RecessCorrection || !(*RecessCorrection).IsValid() ||
        !(*RecessCorrection)->TryGetObjectField(
            TEXT("groupCountsBySuffix"),
            RecessSuffixCounts) ||
        !RecessSuffixCounts || !(*RecessSuffixCounts).IsValid() ||
        !ReadExactString(
            *RecessCorrection,
            TEXT("sourceMaterial"),
            TEXT("M_IPV3_Recess"),
        ...
        !ReadExactString(
            *RecessCorrection,
            ...
            TEXT("M_IPV4_Render"),
            Error) ||
        !ReadInteger(*RecessCorrection, TEXT("groupCount"), CorrectionGroups, Error) ||
        CorrectionGroups != 531 ||
        !ReadInteger(*RecessCorrection, TEXT("triangleCount"), CorrectionTriangles, Error) ||
        CorrectionTriangles != 6372 ||
        !ReadInteger(*RecessCorrection, TEXT("unknownGroupCount"), UnknownGroups, Error) ||
        UnknownGroups != 0 ||
        !ReadInteger(*RecessSuffixCounts, TEXT("_DarkReveal"), DarkRevealGroups, Error) ||
        DarkRevealGroups != 222 ||
        !ReadInteger(*RecessSuffixCounts, TEXT("_SealedRecess"), SealedGroups, Error) ||
        SealedGroups != 99 ||
        !ReadInteger(
            *RecessSuffixCounts,
            TEXT("_FullSilhouetteLouvreRecess"),
            LouvreRecessGroups,
            Error) ||
        LouvreRecessGroups != 111 ||
        !ReadInteger(
            *RecessSuffixCounts,
            TEXT("_FullSilhouetteRecessBacking"),
            BackingGroups,
            Error) ||
        BackingGroups != 99)
    {
        OutReport = TEXT("V4_GEOMETRY_CONTRACT_INVALID: the reviewed broad-Recess-to-Render semantic census changed. ") + Error;
        return false;
    }
    ...
    if (!(*DetailMetrics)->TryGetObjectField(
            TEXT("v4RoofWindingLogicalAverageNormals"),
            LogicalSlateNormals) ||
        !LogicalSlateNormals || !(*LogicalSlateNormals).IsValid() ||
        !(*DetailMetrics)->TryGetObjectField(
            TEXT("v4RoofWindingUE55DiskAverageNormals"),
            DiskSlateNormals) ||
        !DiskSlateNormals || !(*DiskSlateNormals).IsValid())
    {
        OutReport = TEXT("V4_GEOMETRY_CONTRACT_INVALID: slate-winding normal evidence is absent.");
        return false;
    }
    ...
    const FSlateNormalExpectation SlateExpectations[] = {
        {TEXT("V4CentralFrontSlateTile_"), 1, 1.0, -1.0},
        {TEXT("V4CentralRearSlateTile_"), 1, -1.0, 1.0},
        {TEXT("V4CentralEastSlateTile_"), 0, 1.0, 1.0},
        {TEXT("V4CentralWestSlateTile_"), 0, -1.0, -1.0}};
    for (const FSlateNormalExpectation& Expectation : SlateExpectations)
    {
        ...
        {
            OutReport = FString::Printf(
                TEXT("V4_GEOMETRY_CONTRACT_INVALID: slate slope '%s' is not outward/upward in logical and UE5.5 disk coordinates. %s"),
                Expectation.Group,
                *Error);
            return false;
        }
    ...
    if (!Manifest->TryGetArrayField(TEXT("files"), Files) ||
        !Files || Files->Num() != 1)
    {
        OutReport = TEXT("V4_GEOMETRY_MANIFEST_INVALID: exactly one hero file is required.");
        return false;
    }
    ...
    if (!Record.IsValid() ||
        ...
        Path != TEXT("SM_IstanaPublicViewV4_Building_Hero.obj") ||
        !Record->TryGetStringField(TEXT("role"), Role) ||
        Role != TEXT("BUILDING_HERO_VISUAL_V4") ||
        ...
        OutContract.SourceBytes != 386029067)
    {
        OutReport = TEXT("V4_GEOMETRY_MANIFEST_INVALID: hero file record changed. ") + Error;
        return false;
    }
    ...
    {
        OutReport = TEXT("V4_GEOMETRY_MANIFEST_INVALID: metrics or exact M_IPV4 slot roster changed. ") + Error;
        return false;
    }
    for (const FString& Slot : OutContract.MaterialSlots)
    {
        if (!Slot.StartsWith(TEXT("M_IPV4_")) || Slot.StartsWith(TEXT("M_IPV_")))
        {
            OutReport = TEXT("V4_GEOMETRY_MANIFEST_INVALID: legacy M_IPV_* slots are forbidden.");
            return false;
        }
    }
    ...
    if (!ValidateFrozenFile(
            ...
            Error))
    {
        OutReport = TEXT("V4_GEOMETRY_SOURCE_INVALID: ") + Error;
        return false;
    }
    OutReport = FString::Printf(
        TEXT("Validated exact %lld-byte v4 hero OBJ (%d triangles, eleven M_IPV4 slots, regular static mesh/no Nanite)."),
        OutContract.SourceBytes,
...
FString ForbiddenV4TextureObjectPath(const FHeroTextureSpec& Spec)
{
    return FString::Printf(
        TEXT("%s/Textures/%s.%s"),
        *MaterialAssetRoot,
...
bool ValidateV4NormalStrengthOwnership(
    const TSharedPtr<FJsonObject>& Contract,
    const TSharedPtr<FJsonObject>& Interface,
    const TSharedPtr<FJsonObject>& GeneratedManifest,
    FString& OutError)
{
    ...
    if (!Contract.IsValid() || !Interface.IsValid() ||
        ...
        !GeneratedOwnership || !(*GeneratedOwnership).IsValid())
    {
        OutError = TEXT("V4/V3 normal-strength ownership objects are absent.");
        return false;
    }
        ...
        RuntimeApplicationCount != 1)
    {
        if (OutError.IsEmpty())
        {
            OutError = TEXT("V4 normal amplitude must be applied exactly once to runtime-neutral V3 maps.");
        }
        return false;
    }
    ...
    for (const TSharedPtr<FJsonValue>& Value : *GeneratedMaterials)
    {
                ...
                OutError))
        {
            if (OutError.IsEmpty())
            {
                OutError = TEXT("A referenced V3 normal map already contains V4 runtime strength.");
            }
            return false;
        }
    }
    ...
    FString& OutError)
{
    if (!ReadExactString(
            Interface,
            TEXT("schema"),
            TEXT("triad.istana_hero_material_unreal_interface.v4"),
            OutError) ||
        !ReadExactString(Interface, TEXT("version"), TEXT("4.0.0"), OutError) ||
        !ReadExactString(
            Interface,
            TEXT("scope"),
            TEXT("BUILDING_HERO_VISUAL_V4_ONLY"),
            OutError) ||
        !ReadExactString(
            Interface,
            TEXT("contentRoot"),
        ...
        !ReadExactString(
            ...
            TEXT("ADDITIVE_V4_MASTERS_AND_INSTANCES_REFERENCE_FROZEN_V3_TEXTURE_PACKAGES_IN_PLACE"),
            OutError))
    {
        return false;
    }
    ...
    for (const TSharedPtr<FJsonValue>& Value : *Rows)
    {
        ...
        if (!Row.IsValid() ||
            ...
            Spec.TextureSurfaceIdV3 != Spec.Id ||
            !ExpectedTextureSurfaces.Contains(Spec.TextureSurfaceIdV3) ||
            SeenTextureSurfaces.Contains(Spec.TextureSurfaceIdV3) ||
            !ReadStringArray(Row, TEXT("replaceSlotsV4"), Spec.V4Slots, OutError) ||
            ...
            SeenAssets.Contains(Spec.AssetName) || Spec.V4Slots.Num() < 1)
        {
            if (OutError.IsEmpty())
            {
        ...
        for (const FString& Slot : Spec.V4Slots)
        {
            ...
            {
                OutError = FString::Printf(
                    TEXT("Hero material interface has invalid or duplicate v4 slot alias '%s'."),
                    *Slot);
                return false;
            }
            SeenSlots.Add(Slot);
        }
        if (Spec.ParentAssetName != TEXT("M_IPV_HeroSurface_V4") &&
            Spec.ParentAssetName != TEXT("M_IPV_HeroGlass_V4"))
        {
            OutError = TEXT("Hero material instance parent escaped the two frozen v4 masters.");
            return false;
        }
        ...
        const bool bGlass = Spec.ParentAssetName == TEXT("M_IPV_HeroGlass_V4");
        ...
        {
            OutError = FString::Printf(
                TEXT("Hero material instance '%s' changed its exact v4 parameter roster."),
                *Spec.AssetName);
            return false;
        }
        Spec.StaticSwitches = {
    ...
    if (!Interface->TryGetObjectField(
            TEXT("specialSlotBindingsV4"), SpecialBindings) ||
        !SpecialBindings || !(*SpecialBindings).IsValid() ||
        (*SpecialBindings)->Values.Num() != 2)
    {
        OutError = TEXT("Hero material interface lacks special v4 slot bindings.");
        return false;
    }
    ...
    for (const TCHAR* SlotName : SpecialRows)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("Special v4 alias '%s' changed."),
                SlotName);
            return false;
        }
        ...
        {
            OutError = FString::Printf(
                TEXT("Special v4 binding '%s' is absent."),
                SlotName);
            return false;
        }
        FHeroMaterialInstanceSpec Spec;
        ...
        if (!(*Binding)->TryGetStringField(TEXT("asset"), AssetName) ||
            ...
            ParentAssetName != TEXT("M_IPV_HeroSurface_V4") ||
            SeenAssets.Contains(AssetName))
        {
            OutError = FString::Printf(
                TEXT("Special v4 binding '%s' changed its asset or parent."),
                SlotName);
            return false;
        }
        Spec.AssetName = AssetName;
        Spec.ParentAssetName = ParentAssetName;
        Spec.V4Slots = {SlotName};
        ...
        {
            OutError = FString::Printf(
                TEXT("Special v4 binding '%s' changed its fail-closed static switches."),
                SlotName);
            return false;
        }
    ...
    {
        OutError = TEXT("Hero material interface does not bind all eleven M_IPV4 slots.");
        return false;
    }
    return true;
}

bool ValidateV4TextureReuseAndGraphContract(
    const TSharedPtr<FJsonObject>& Contract,
    const TSharedPtr<FJsonObject>& Interface,
    FString& OutError)
{
    ...
    if (!Contract.IsValid() || !Interface.IsValid() ||
        ...
        !ReadInteger(
            *TextureReferences,
            TEXT("v4TexturePackageCount"),
            V4TexturePackageCount,
            OutError) ||
        V4TexturePackageCount != 0 ||
        !ReadInteger(
            *TextureReferences,
        ...
        !ReadExactBool(
            *TextureReferences,
            TEXT("noV4TextureCopy"),
            true,
            OutError) ||
        !ReadExactString(
            *GraphContract,
            TEXT("opaqueGraphSchema"),
            TEXT("triad.istana_hero_surface_graph.v4.1"),
            OutError) ||
        !ReadExactString(
            *GraphContract,
            TEXT("glassGraphSchema"),
            TEXT("triad.istana_hero_glass_graph.v4.2"),
            OutError) ||
        !ReadExactBool(
            *GraphContract,
            ...
            OutError))
    {
        if (OutError.IsEmpty())
        {
            OutError = TEXT("V4 texture-reuse or material-local SSR graph contract changed.");
        }
        return false;
    }
    ...
    {
        OutError = TEXT("V4 texture destination must remain JSON null; V4 texture packages are forbidden.");
        return false;
    }
    ...
    {
        OutError = TEXT("V4 frozen-V3 dependency provenance is absent.");
        return false;
    }
        ...
        const FString& ExpectedDigest)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 frozen dependency '%s' digest changed."), Field);
            return false;
        }
        return true;
    };
    ...
    FString& OutReport)
{
    ...
    {
        OutReport = TEXT("V4_MATERIALS_NOT_FROZEN: final byte-identical HeroMaterialsV4 artifacts have not been bound.");
        return false;
    }
    FString Error;
    TSharedPtr<FJsonObject> Contract;
    ...
    if (!ValidateFrozenFile(
        ...
        !ReadExactString(
            Contract,
            TEXT("schema"),
            TEXT("triad.istana_hero_materials.v4"),
            Error) ||
        !ReadExactString(Contract, TEXT("version"), TEXT("4.0.0"), Error) ||
        !ReadExactString(
            MaterialFreeze,
            TEXT("schema"),
            TEXT("triad.istana_hero_materials_v4.freeze.v1"),
            Error) ||
        !ReadExactString(
            MaterialFreeze,
            TEXT("freezeStatus"),
            TEXT("FROZEN_AFTER_EXACT_V3_TEXTURE_PAYLOAD_VALIDATION_GEOMETRY_SEMANTIC_BINDING_AND_INDEPENDENT_REVIEW"),
            Error))
    {
        OutReport = TEXT("V4_MATERIAL_CONTRACT_INVALID: ") + Error;
        return false;
    }
    const TSharedPtr<FJsonObject>* Scope = nullptr;
    ...
    const TSharedPtr<FJsonObject>* PreservedTriangleMapping = nullptr;
    const TSharedPtr<FJsonObject>* InterfaceGeometryBinding = nullptr;
    const TSharedPtr<FJsonObject>* FreezeGeometryBinding = nullptr;
    ...
    int64 BoundBroadGroups = 0;
    int64 BoundBroadTriangles = 0;
    int64 BoundTerminalGroups = 0;
    int64 BoundTerminalTriangles = 0;
    int64 BoundHelperRecessTriangles = -1;
    if (!Contract->TryGetObjectField(TEXT("scope"), Scope) ||
        ...
        !Contract->TryGetObjectField(
            TEXT("semanticV3ToV4SlotMapping"), SemanticRoleMapping) ||
        !SemanticRoleMapping || !(*SemanticRoleMapping).IsValid() ||
        !Contract->TryGetObjectField(
            TEXT("preservedTriangleV3ToV4SlotMapping"),
            PreservedTriangleMapping) ||
        !PreservedTriangleMapping || !(*PreservedTriangleMapping).IsValid() ||
        !Interface->TryGetObjectField(
        ...
        !MaterialFreeze->TryGetObjectField(
            TEXT("geometryBinding"), FreezeGeometryBinding) ||
        !FreezeGeometryBinding || !(*FreezeGeometryBinding).IsValid() ||
        !ReadStringArray(
            Contract,
            TEXT("requiredV4SlotOrder"),
            ContractOrderedSlots,
            Error) ||
        !ReadStringArray(
            Interface,
            TEXT("orderedHeroSlotsV4"),
            InterfaceOrderedSlots,
            Error) ||
        !ReadStringArray(
            Interface,
            TEXT("effectiveV4SlotOrder"),
        ...
        !ReadExactBool(
            *Scope,
            TEXT("additiveV4MaterialNamespaceOnly"),
            true,
            Error) ||
        !ReadExactString(
            *Scope,
        ...
        !ReadInteger(
            *Scope,
            TEXT("generatedOrCopiedTextureCountV4"),
        ...
        !ReadExactBool(
            *Scope, TEXT("changesV1V2V3MaterialPackages"), false, Error) ||
        ...
        !ReadExactString(
            *GeometryPartition,
            TEXT("preservedBroadV3RecessSource"),
            TEXT("M_IPV3_Recess"),
            Error) ||
        !ReadExactString(
            *GeometryPartition,
            TEXT("preservedBroadV3RecessTarget"),
            TEXT("M_IPV4_Render"),
            Error) ||
        !ReadExactString(
            *GeometryPartition,
            TEXT("v4AuthoredTerminalRecessSlot"),
            TEXT("M_IPV4_Recess"),
            Error) ||
        !ReadExactBool(
            *GeometryPartition,
        ...
        !ReadInteger(
            *InterfaceGeometryBinding,
            TEXT("preservedBroadV3RecessGroupCount"),
            BoundBroadGroups,
            Error) ||
        BoundBroadGroups != 531 ||
        !ReadInteger(
            *InterfaceGeometryBinding,
            TEXT("preservedBroadV3RecessTriangleCount"),
            BoundBroadTriangles,
            Error) ||
        BoundBroadTriangles != 6372 ||
        !ReadInteger(
            *InterfaceGeometryBinding,
            TEXT("v4AuthoredTerminalRecessGroupCount"),
            BoundTerminalGroups,
            Error) ||
        BoundTerminalGroups != 39 ||
        !ReadInteger(
            *InterfaceGeometryBinding,
            TEXT("v4AuthoredTerminalRecessTriangleCount"),
            BoundTerminalTriangles,
            Error) ||
        BoundTerminalTriangles != 468 ||
        !ReadInteger(
            *InterfaceGeometryBinding,
            TEXT("v4HelperV3RecessTriangleCount"),
            BoundHelperRecessTriangles,
            Error) ||
        BoundHelperRecessTriangles != 0 ||
        !ReadExactBool(
            *InterfaceGeometryBinding,
            TEXT("openingSizedNearBlackBackingPresent"),
            false,
        ...
        !ReadExactBool(
            *RuntimeRequirements,
            ...
            Error))
    {
        OutReport = TEXT("V4_MATERIAL_CONTRACT_INVALID: hero-only scope or exact ordered slot roster changed. ") + Error;
        return false;
    }
    TArray<FString> GeneratedOrderedV3Slots;
    if (!ValidateV4TextureReuseAndGraphContract(
        ...
        !ValidateV4NormalStrengthOwnership(
            Contract,
            Interface,
            GeneratedManifest,
            Error) ||
        ...
        !ReadExactBool(
            ...
            Error))
    {
        OutReport = TEXT("V4_MATERIAL_PACK_INVALID: ") + Error;
        return false;
    }
    ...
    if (!GeneratedManifest->TryGetObjectField(TEXT("resolutions"), Resolutions) ||
        ...
        DirtResolution != 2048)
    {
        OutReport = TEXT("V4_MATERIAL_PACK_INVALID: exact generated resolutions changed. ") + Error;
        return false;
    }
    ...
    {
        OutReport = TEXT("V4_MATERIAL_PACK_INVALID: generated material roster is incomplete.");
        return false;
    }
    TSet<FString> SeenIds;
    TSet<FString> SeenFiles;
    ...
    for (const TSharedPtr<FJsonValue>& Value : *MaterialRows)
    {
        ...
        {
            OutReport = TEXT("V4_MATERIAL_PACK_INVALID: generated material row is unsafe or duplicated.");
            return false;
        }
        ...
        if (!InterfaceSpec || InterfaceSpec->TextureSurfaceIdV3 != Id ||
            !HasExactV3ToV4SlotMapping(
                GeneratedV3Slots, InterfaceSpec->V4Slots) ||
            !bTargetInstanceMatchesV3)
        {
            OutReport = FString::Printf(
                TEXT("V4_MATERIAL_PACK_INVALID: generated/interface binding differs for '%s'."),
                *Id);
            return false;
        }
        SeenIds.Add(Id);
    ...
    {
        OutReport = TEXT("V4_MATERIAL_PACK_INVALID: shared architectural-dirt receptivity map changed. ") + Error;
        return false;
    }
    ...
    {
        OutReport = TEXT("V4_MATERIAL_PACK_INVALID: exactly 57 generated maps are required.");
        return false;
    }
    ...
    {
        OutReport = TEXT("V4_MATERIAL_PACK_INVALID: Generated PNG roster differs from the exact manifest.");
        return false;
    }
    OutReport = FString::Printf(
        TEXT("Validated additive HeroMaterialsV4 interface and ten V4 instances referencing %d exact frozen HeroMaterialsV3 texture packages in place; no V4 texture payload is generated or copied, and no measured-material claim is made."),
        OutPack.Textures.Num());
    return true;
}

bool ValidateCompleteV4SourceSet(
...
bool IsEditorOperationSafe(FString& OutError)
{
    ...
    {
        OutError = TEXT("Stop Play-In-Editor before running hero-v4 editor operations.");
        return false;
    }
    ...
    if (DirtyMaps.Num() > 0 || DirtyContent.Num() > 0)
    {
        ...
        Names.Sort();
        OutError = TEXT("Refusing hero-v4 mutation while packages are dirty: ") +
...
const TCHAR* HeroPayloadSealSchema =
    TEXT("triad.istana_public_view_hero_v4.embedded_payload.v1");
const TCHAR* HeroPayloadSchemaMetadataKey = TEXT("TRIADHeroV4PayloadSchema");
const TCHAR* HeroPayloadKindMetadataKey = TEXT("TRIADHeroV4PayloadKind");
const TCHAR* HeroPayloadDigestMetadataKey = TEXT("TRIADHeroV4PayloadDigest");
    ...
    FString& OutError)
{
    ...
    {
        OutError = TEXT("Cannot seal an absent or empty v4 embedded payload.");
        return false;
    }
    UMetaData* MetaData = Asset->GetOutermost()->GetMetaData();
    if (!MetaData)
    {
        OutError = TEXT("Could not allocate v4 embedded-payload metadata.");
        return false;
    }
    MetaData->SetValue(
    ...
    FString& OutError)
{
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 asset '%s' embedded-payload seal is absent or stale."),
    ...
    int32 Y)
{
    ...
    if (Parameter)
    {
        ...
        Parameter->Group = TEXT("Istana Hero V4");
    }
    return Parameter;
}
    ...
    FString& OutError)
{
    ...
    {
        OutError = FString::Printf(
            TEXT("Could not connect v4 material graph edge '%s' -> '%s'."),
            Output,
            Input);
        return false;
    }
    ...
    FString& OutError)
{
    ...
    {
        OutError = FString::Printf(
            TEXT("Could not connect v4 material property %d."),
    ...
    FString& OutError)
{
    ...
    UMaterial* Material = Factory
        ? Cast<UMaterial>(AssetTools.CreateAsset(
            ...
            Factory,
            FName(TEXT("TRIAD.ImportIstanaPublicViewHeroV4Assets"))))
        : nullptr;
    if (!Material)
    {
        OutError = TEXT("Could not create M_IPV_HeroSurface_V4.");
        return nullptr;
    }
    Material->Modify();
    ...
    UMaterialExpressionCustom* RoughnessResponse = CreateCustomExpression(
        Material,
        TEXT("TRIAD_IPV4_OpaqueRoughness"),
    ...
    UMaterialExpressionCustom* MetallicResponse = CreateCustomExpression(
        Material,
        TEXT("TRIAD_IPV4_OpaqueMetallic"),
    ...
    {
        OutError = TEXT("Could not allocate the complete M_IPV_HeroSurface_V4 parameter graph.");
        return nullptr;
    }
    ...
    {
        OutError = TEXT("Opaque v4 master lacks a frozen default texture binding.");
        return nullptr;
    }
    ...
    FString& OutError)
{
    ...
    if (!Material)
    {
        OutError = TEXT("Could not create M_IPV_HeroGlass_V4.");
        return nullptr;
    }
    Material->Modify();
    Material->MaterialDomain = MD_Surface;
    ...
    // a renderer/project CVar and is sealed into the V4 graph fingerprint.
    ...
    UMaterialExpressionCustom* RoughnessResponse = CreateCustomExpression(
        Material,
        TEXT("TRIAD_IPV4_GlassRoughness"),
    ...
    UMaterialExpressionCustom* NormalResponse = CreateCustomExpression(
        Material,
        TEXT("TRIAD_IPV4_GlassNormalRNM"),
        TEXT("float baseScale = max(BaseStrength, 0.0);\n")
        TEXT("float detailScale = max(DetailStrength, 0.0);\n")
        TEXT("float3 n1 = normalize(float3(BaseNormal.xy * baseScale, lerp(1.0, BaseNormal.z, saturate(baseScale))));\n")
        TEXT("float3 n2 = normalize(float3(DetailNormal.xy * detailScale, lerp(1.0, DetailNormal.z, saturate(detailScale))));\n")
    ...
    {
        OutError = TEXT("Could not allocate the complete M_IPV_HeroGlass_V4 graph.");
        return nullptr;
    }
    Uv0->CoordinateIndex = 0;
    ...
    if (!BaseColor->Texture || !Normal->Texture || !Orm->Texture ||
        !DetailNormal->Texture || !Macro->Texture || !SurfaceMasks->Texture)
    {
        OutError = TEXT("Glass v4 master lacks a frozen default texture binding.");
        return nullptr;
    }
    if (!ConnectExpression(Uv0, TEXT(""), TileUv, TEXT("A"), OutError) ||
        !ConnectExpression(TileMeters, TEXT(""), TileUv, TEXT("B"), OutError) ||
...
UMaterialInstanceConstant* CreateHeroMaterialInstance(
    ...
    FString& OutError)
{
    UMaterial* Parent = Spec.ParentAssetName == TEXT("M_IPV_HeroGlass_V4")
        ? GlassMaster
        : OpaqueMaster;
    ...
    if (!Factory || !Parent)
    {
        OutError = TEXT("Could not allocate a v4 material-instance factory or parent.");
        return nullptr;
    }
    ...
    {
        OutError = FString::Printf(
            TEXT("Could not create v4 material instance '%s'."),
            *Spec.AssetName);
        return nullptr;
    }
    Instance->Modify();
    ...
    if (!Spec.bSpecialParameterOnly)
    {
        ...
        {
            if (Spec.ParentAssetName == TEXT("M_IPV_HeroGlass_V4") &&
        ...
        if (Spec.ParentAssetName != TEXT("M_IPV_HeroGlass_V4"))
        {
            ...
            if (!Shared)
            {
                OutError = TEXT("Shared v4 architectural-dirt receptivity mask is absent.");
                return nullptr;
            }
            Instance->SetTextureParameterValueEditorOnly(
...
const TCHAR* HeroGraphSealSchema =
    TEXT("triad.istana_public_view_hero_v4.material_graph_seal.v1");
const TCHAR* HeroGraphSchemaMetadataKey = TEXT("TRIADHeroV4GraphSchema");
const TCHAR* HeroGraphShaMetadataKey = TEXT("TRIADHeroV4GraphSha256");

FString ExpectedHeroGraphRecipeSchema(const UMaterial* Material)
{
    if (Material && Material->GetName() == TEXT("M_IPV_HeroSurface_V4"))
    {
        return TEXT("triad.istana_hero_surface_graph.v4.1");
    }
    if (Material && Material->GetName() == TEXT("M_IPV_HeroGlass_V4"))
    {
        return TEXT("triad.istana_hero_glass_graph.v4.2");
    }
    return FString();
}
    ...
    FString& OutError)
{
    if (!Material)
    {
        OutError = TEXT("Cannot fingerprint a null v4 master material.");
        return false;
    }
    ...
    for (UMaterialExpression* Expression : Material->GetExpressions())
    {
        if (!Expression || Expression->Desc.IsEmpty() ||
            !Expression->Desc.StartsWith(TEXT("TRIAD_IPV4_NODE_")) ||
            NodeIds.Contains(Expression->Desc))
        {
            OutError = TEXT("V4 graph fingerprint requires unique stable node identifiers.");
            return false;
        }
    ...
    {
        OutError = TEXT("V4 graph fingerprint refuses an unknown master recipe.");
        return false;
    }
    ...
    for (UMaterialExpression* Expression : Expressions)
    {
        ...
        for (FExpressionInputIterator It{Expression}; It; ++It)
        {
            ...
            {
                OutError = TEXT("V4 graph edge points outside its sealed master material.");
                return false;
            }
    ...
    {
        OutError = TEXT("Could not calculate the v4 material graph SHA-256.");
        return false;
    }
    OutError.Reset();
    return true;
...
bool SealHeroMaterialGraph(UMaterial* Material, FString& OutError)
{
        ...
        !Material->GetOutermost())
    {
        if (OutError.IsEmpty())
        {
            OutError = TEXT("V4 master package is absent while sealing its graph.");
        }
        return false;
    }
    ...
    if (!MetaData)
    {
        OutError = TEXT("Could not allocate v4 master graph metadata.");
        return false;
    }
    MetaData->SetValue(
        Material,
    ...
    FString& OutError)
{
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 master '%s' graph seal is absent or stale (actual %s)."),
            *Material->GetName(),
            *ActualDigest);
        return false;
    }
    ...
    FString& OutError)
{
    if (!Expression || Expression->Description.IsEmpty() ||
        !Expression->Description.StartsWith(TEXT("TRIAD_IPV4_")) ||
        Expression->Code.IsEmpty() || Expression->Inputs.Num() == 0)
    {
        OutError = TEXT("V4 material contains an unidentified or empty custom response node.");
        return false;
    }
    TSet<FName> Names;
         ...
         ++InputIndex)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 custom response '%s' input[%d] of %d is unnamed."),
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 custom response '%s' input[%d] '%s' duplicates an earlier input name."),
                *Expression->Description,
                InputIndex,
                *InputName);
            return false;
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 custom response '%s' input[%d] '%s' is directly disconnected."),
                *Expression->Description,
                InputIndex,
                *InputName);
            return false;
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 custom response '%s' input[%d] '%s' traces to no source expression (direct source '%s')."),
                *Expression->Description,
                InputIndex,
                *InputName,
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 custom response '%s' input[%d] '%s' is not referenced as an exact HLSL identifier."),
                *Expression->Description,
                InputIndex,
                *InputName);
            return false;
    ...
    FString& OutError)
{
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 master '%s' did not produce a valid regular SM5 shader map."),
    ...
    FString& OutError)
{
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 master '%s' has invalid domain/blend/shading settings."),
            *ExpectedName);
        return false;
    }
    ...
    for (const EMaterialProperty Property : Properties)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 master '%s' has a disconnected required material property %d."),
                *ExpectedName,
                static_cast<int32>(Property));
            return false;
        }
    ...
    for (UMaterialExpression* Expression : Material->GetExpressions())
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 master '%s' contains a forbidden duplicate-prone StaticSwitchParameter node."),
                *ExpectedName);
            return false;
        }
        if (const UMaterialExpressionParameter* Parameter =
                Cast<UMaterialExpressionParameter>(Expression))
        {
            ...
            {
                OutError = FString::Printf(
                    TEXT("V4 master '%s' has an unnamed, duplicate, or output-unreachable parameter '%s'."),
                    *ExpectedName,
                ...
                Cast<UMaterialExpressionTextureSampleParameter2D>(Expression))
        {
            ...
            {
                OutError = FString::Printf(
                    TEXT("V4 master '%s' texture parameter '%s' has stale sampling semantics or default binding."),
                    *ExpectedName,
                ...
                Cast<UMaterialExpressionStaticSwitch>(Expression))
        {
            ...
            {
                OutError = FString::Printf(
                    TEXT("V4 master '%s' contains an incomplete True/False/Value static branch."),
                    *ExpectedName);
                return false;
            }
        }
                ...
                Cast<UMaterialExpressionCustom>(Expression))
        {
                ...
                CustomDescriptions.Contains(Custom->Description))
            {
                ...
                {
                    OutError = FString::Printf(
                        TEXT("V4 master '%s' duplicates custom response '%s'."),
                        *ExpectedName,
                        *Custom->Description);
                }
                return false;
                ...
                Cast<UMaterialExpressionBumpOffset>(Expression))
        {
            ...
            {
                OutError = TEXT("Opaque v4 bump-offset branch is disconnected or changed.");
                return false;
            }
        }
    }
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 master '%s' contains an output-unreachable or extra expression node."),
            *ExpectedName);
        return false;
    }
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 master '%s' does not retain the exact interface parameter roster."),
            *ExpectedName);
        return false;
    }
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 master '%s' has the wrong response-node count."),
            *ExpectedName);
        return false;
    }
    for (const FString& Description : ExpectedCustomDescriptions)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 master '%s' lacks required response node '%s'."),
                *ExpectedName,
                *Description);
            return false;
        }
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 master '%s' has an invalid bump-offset node count."),
            *ExpectedName);
        return false;
    }
    ...
    FString& OutError)
{
    ...
    OutError = FString::Printf(
        TEXT("V4 material instance '%s' %s override roster differs: missing=[%s]; unexpected=[%s]; expected=[%s]; actual=[%s]."),
        *AssetName,
        OverrideKind,
    ...
    FString& OutError)
{
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 material instance '%s' has an invalid path or parent."),
            *Spec.AssetName);
        return false;
    }
    ...
    for (const FScalarParameterValue& Value : Instance->ScalarParameterValues)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 material instance '%s' has an invalid or duplicate scalar override."),
                *Spec.AssetName);
            return false;
        }
    ...
    for (const FVectorParameterValue& Value : Instance->VectorParameterValues)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 material instance '%s' has an invalid or duplicate vector override."),
                *Spec.AssetName);
            return false;
        }
    ...
    if (!Spec.bSpecialParameterOnly)
    {
        ExpectedTextureNames = Spec.ParentAssetName == TEXT("M_IPV_HeroGlass_V4")
            ? TSet<FName>{
                TEXT("Tex_BaseColor"), TEXT("Tex_Normal"), TEXT("Tex_ORM"),
                TEXT("Tex_DetailNormal"), TEXT("Tex_MacroVariation"),
                TEXT("Tex_SurfaceMasks")}
    ...
    for (const FTextureParameterValue& Value : Instance->TextureParameterValues)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 material instance '%s' has an invalid or duplicate texture override."),
                *Spec.AssetName);
            return false;
        }
         ...
         StaticParameters.StaticSwitchParameters)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 material instance '%s' has an invalid or duplicate static override."),
                *Spec.AssetName);
            return false;
        }
    ...
    for (const TPair<const TCHAR*, int32>& Family : UnexpectedOverrideFamilies)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 material instance '%s' has %d unexpected %s override(s)."),
                *Spec.AssetName,
                Family.Value,
                Family.Key);
            return false;
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 material instance '%s' has an unexpected material-layer override."),
            *Spec.AssetName);
        return false;
    }
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 material instance '%s' enables forbidden base-property override flag(s): [%s]."),
            *Spec.AssetName,
    ...
    for (const TPair<FName, float>& Pair : Spec.Scalars)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 material instance '%s' scalar '%s' changed."),
                *Spec.AssetName,
                *Pair.Key.ToString());
            return false;
        }
    ...
    for (const TPair<FName, FLinearColor>& Pair : Spec.Vectors)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 material instance '%s' vector '%s' changed."),
                *Spec.AssetName,
                *Pair.Key.ToString());
            return false;
        }
    ...
    for (const TPair<FName, bool>& Pair : Spec.StaticSwitches)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 material instance '%s' static switch '%s' changed."),
                *Spec.AssetName,
                *Pair.Key.ToString());
            return false;
        }
    ...
    if (!Spec.bSpecialParameterOnly)
    {
        ...
        for (const TPair<const TCHAR*, const TCHAR*>& Binding : TextureBindings)
        {
            ...
            {
                OutError = FString::Printf(
                    TEXT("V4 material instance '%s' texture '%s' changed."),
                    *Spec.AssetName,
                    Binding.Value);
                return false;
            }
        ...
        if (Spec.ParentAssetName != TEXT("M_IPV_HeroGlass_V4"))
        {
            ...
            {
                OutError = FString::Printf(
                    TEXT("V4 material instance '%s' shared architectural-dirt map changed."),
                    *Spec.AssetName);
                return false;
            }
        }
        ...
        CompileErrors.Num() != 0)
    {
        ...
        OutError = FString::Printf(
            TEXT("V4 material instance '%s' SM5 permutation invalid: ")
    ...
    FString& OutError)
{
    ...
    {
        OutError = TEXT("V4 hero lacks a stable render-data key or lighting GUID.");
        return false;
    }
    FString Canonical;
    AppendGraphToken(
        Canonical,
        TEXT("triad.istana_public_view_hero_v4.mesh_render_payload.v1"));
    ...
    if (!CalculateSha256Bytes(Utf8.Get(), Utf8.Length(), OutDigest))
    {
        OutError = TEXT("Could not hash the v4 hero render payload identity.");
        return false;
    }
    OutError.Reset();
    return true;
    ...
    FString& OutError)
{
         ...
         ++ImportedIndex)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("Legacy OBJ material slots are not an exact unique v4 permutation at imported index %d: slot='%s' imported='%s'."),
                ImportedIndex,
                *Slot,
                *ImportedSlot);
            return false;
         ...
         ++OrderedIndex)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("Legacy OBJ import omitted required v4 slot '%s'."),
    ...
    FString& OutError)
{
    ...
    {
        OutError = TEXT("V4 hero mesh path/LOD/triangle/no-Nanite contract failed.");
        return false;
    }
    ...
    {
        OutError = FString::Printf(
            TEXT("V4 hero imported bounds changed: min=%s max=%s expected min=%s max=%s cm."),
            *ActualMin.ToString(),
            *ActualMax.ToString(),
    ...
    {
        OutError = TEXT("V4 hero source-model normal/tangent/identity-scale contract failed.");
        return false;
    }
    ...
    {
        OutError = TEXT("V4 visual hero must contain no simple or complex-as-simple collision.");
        return false;
    }
    if (Mesh->GetStaticMaterials().Num() != ExpectedHeroSlots().Num())
    {
        OutError = TEXT("V4 hero does not have exactly eleven material slots.");
        return false;
    }
    TSet<FString> SeenSlots;
    ...
    for (int32 SlotIndex = 0; SlotIndex < StaticMaterials.Num(); ++SlotIndex)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 hero material binding/order is invalid at index %d: actual='%s' expected='%s'."),
                SlotIndex,
                *Slot,
    ...
    if (SeenSlots.Num() != ExpectedHeroSlots().Num())
    {
        OutError = TEXT("V4 hero material slot roster is incomplete.");
        return false;
    }
    ...
    {
        OutError = TEXT("V4 hero mesh-description polygon groups or render sections are incomplete.");
        return false;
    }
         ...
         MeshDescription->PolygonGroups().GetElementIDs())
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 hero polygon-group/render-section material mapping is invalid at section %d for slot '%s'."),
                SectionIndex,
                *Slot);
            return false;
        }
    ...
    {
        OutError = TEXT("V4 hero render-section material roster is incomplete.");
        return false;
    }
    if (!ValidateSingleSourceProvenance(
...
enum class EHeroV4AssetState : uint8
{
    Absent,
    CompleteValid,
    PartialOrInvalid
    ...
    TSet<FString>& OutPaths)
{
    ...
    OutPaths.Add(MaterialObjectPath(TEXT("M_IPV_HeroSurface_V4")));
    OutPaths.Add(MaterialObjectPath(TEXT("M_IPV_HeroGlass_V4")));
...
EHeroV4AssetState InspectHeroV4Assets(
    UEditorAssetSubsystem* AssetSubsystem,
    const FHeroGeometryContract& Geometry,
    const FHeroMaterialPack& Pack,
    UStaticMesh** OutHero,
    FString& OutReport)
{
    if (!AssetSubsystem)
    {
        ...
        return EHeroV4AssetState::PartialOrInvalid;
    }
    ...
    {
        OutReport = TEXT(
            "Asset Registry could not recursively census the exact V4 hero/material roots.");
        return EHeroV4AssetState::PartialOrInvalid;
    }
    ...
    for (const FAssetData& AssetData : NamespaceAssets)
    {
        ...
        {
            OutReport = TEXT(
                "Asset Registry returned invalid data while recursively censusing the exact V4 roots.");
            return EHeroV4AssetState::PartialOrInvalid;
        }
    ...
    {
        OutReport = TEXT("V4 hero/material namespace is absent.");
        return EHeroV4AssetState::Absent;
    }
        ...
        MissingPaths.Num() != 0 || UnexpectedPaths.Num() != 0)
    {
        ...
        OutReport = FString::Printf(
            TEXT("V4 Asset Registry namespace census differs from the exact expected object-path set (actual=%d expected=%d missing=[%s] unexpected=[%s]); refusing arbitrary V4 packages, textures, or repair-in-place."),
            ActualPaths.Num(),
            ExpectedPaths.Num(),
    ...
    for (const FHeroTextureSpec& Spec : Pack.Textures)
    {
        if (DoesObjectOrPackageExist(
                AssetSubsystem, ForbiddenV4TextureObjectPath(Spec)))
        {
            OutReport = FString::Printf(
                TEXT("V4 texture copy is forbidden but package/object '%s' exists."),
                *ForbiddenV4TextureObjectPath(Spec));
            return EHeroV4AssetState::PartialOrInvalid;
        }
        ...
        {
            OutReport = TEXT("V4 frozen V3 texture dependency is absent or stale: ") +
                Error;
            return EHeroV4AssetState::PartialOrInvalid;
        }
    ...
    {
        OutReport = FString::Printf(
            TEXT("V4 namespace is partial: %d of %d exact assets exist; refusing overwrite or repair-in-place."),
            ExistingCount,
            ExpectedPaths.Num());
        return EHeroV4AssetState::PartialOrInvalid;
    }
    ...
    UMaterial* OpaqueMaster = LoadObject<UMaterial>(
        nullptr,
        *MaterialObjectPath(TEXT("M_IPV_HeroSurface_V4")));
    UMaterial* GlassMaster = LoadObject<UMaterial>(
        nullptr,
        *MaterialObjectPath(TEXT("M_IPV_HeroGlass_V4")));
    ...
    OutReport = FString::Printf(
        TEXT("Validated non-overwriting v4 asset set: one regular %d-triangle hero, 57 exact frozen V3 texture references with zero V4 texture packages, two additive V4 masters, %d instances, eleven M_IPV4 slot bindings, and no hero collision/Nanite."),
        Geometry.Triangles,
        Pack.Instances.Num());
    return EHeroV4AssetState::CompleteValid;
}
    ...
    FString& OutError)
{
    const FString AdapterDirectory =
        FPaths::ConvertRelativePathToFull(FPaths::Combine(
            ...
            TEXT("TRIAD/IstanaPublicViewV4/LegacyObjMaterialSlots")));
    if (!IFileManager::Get().MakeDirectory(*AdapterDirectory, true))
    {
        OutError = TEXT("Could not create the isolated v4 legacy-OBJ adapter directory.");
        return false;
    }
    const FString MtlFilename = TEXT("IstanaPublicViewV4Slots.mtl");
    ...
    {
        OutError = TEXT("Could not write the isolated v4 material-slot adapter MTL.");
        return false;
    }
    ...
    OutAdaptedObjFilename = FPaths::Combine(
        AdapterDirectory,
        TEXT("SM_IstanaPublicViewV4_Building_Hero.import.obj"));
    ...
    if (!Reader || !Writer)
    {
        OutError = TEXT("Could not open the v4 source/adapter OBJ streams.");
        return false;
    }
    ...
    FString& OutMessage)
{
    ...
    const EHeroV4AssetState ExistingState = InspectHeroV4Assets(
        AssetSubsystem, Geometry, Pack, nullptr, ExistingReport);
    if (ExistingState == EHeroV4AssetState::CompleteValid)
    {
        OutMessage = SourceReport + TEXT(" ") + ExistingReport +
            TEXT(" Existing complete v4 output was accepted idempotently; no package was saved or overwritten.");
        return true;
    }
    if (ExistingState != EHeroV4AssetState::Absent)
    {
        OutMessage = TEXT("V4_IMPORT_REFUSED: ") + ExistingReport;
        return false;
    }
    ...
    for (const FHeroTextureSpec& Spec : Pack.Textures)
    {
        ...
        if (!ValidateHeroTexture(Texture, Spec, Error))
        {
            OutMessage = TEXT("V4_IMPORT_REFUSED_FROZEN_V3_TEXTURE_DEPENDENCY: ") +
                Error;
            return false;
        }
        Textures.Add(FName(*Spec.AssetName), Texture);
    ...
    if (!OpaqueMaster || !GlassMaster ||
        ...
        !ValidateHeroMaster(GlassMaster, true, Error))
    {
        OutMessage = TEXT("UNSAVED_PARTIAL_V4_NAMESPACE: ") + Error;
        return false;
    }
    ...
    {
        OutMessage = TEXT("UNSAVED_PARTIAL_V4_NAMESPACE: not all eleven v4 slots have exact material instances.");
        return false;
    }
    ...
    {
        OutMessage = TEXT("UNSAVED_PARTIAL_V4_NAMESPACE: could not allocate deterministic regular-mesh OBJ import options.");
        return false;
    }
    ...
    if (!Hero)
    {
        OutMessage = TEXT("UNSAVED_PARTIAL_V4_NAMESPACE: OBJ import produced no v4 hero mesh.");
        return false;
    }
    FStaticMeshCompilingManager::Get().FinishCompilation({Hero});
    Hero->Modify();
    ...
    if (!ImportData)
    {
        OutMessage = TEXT("UNSAVED_PARTIAL_V4_NAMESPACE: v4 hero lacks import provenance.");
        return false;
    }
    ImportData->Update(ProjectSourcePath(GeometryObjRelativePath));
    if (Hero->GetNumSourceModels() != 1)
    {
        OutMessage = TEXT("UNSAVED_PARTIAL_V4_NAMESPACE: v4 hero requires exactly one source LOD.");
        return false;
    }
    ...
    for (const FString& Slot : ExpectedHeroSlots())
    {
        ...
        if (MaterialIndex == INDEX_NONE || !Material)
        {
            OutMessage = FString::Printf(
                TEXT("UNSAVED_PARTIAL_V4_NAMESPACE: hero lacks exact slot/material '%s'."),
                *Slot);
            return false;
        }
    ...
    {
        OutMessage = TEXT("SAVE_FAILED_PARTIAL_V4_NAMESPACE: v4 assets validated in memory but did not all save. No V1/V2/V3 package was touched; inspect/delete only the isolated V4 namespaces before retrying.");
        return false;
    }
    FString FinalReport;
    if (InspectHeroV4Assets(
            AssetSubsystem,
            Geometry,
            Pack,
            nullptr,
            FinalReport) != EHeroV4AssetState::CompleteValid)
    {
        OutMessage = TEXT("POST_SAVE_V4_VALIDATION_FAILED: ") + FinalReport;
        return false;
    }
    OutMessage = SourceReport + TEXT(" ") + FinalReport +
        TEXT(" Imported only /Game/TRIAD/IstanaPublicViewV4 and /Game/TRIAD/IstanaPublicView/HeroMaterialsV4; all 57 textures were referenced read-only from HeroMaterialsV3, and no V4 texture package was created. V1/V2/V3 meshes, materials, collision, maps, surroundings, renderer settings, SM6, and project settings were not loaded for mutation or saved.");
    return true;
}
    ...
    FString& OutError)
{
    ...
    {
        OutError = TEXT("Hero-v4 preservation requires exactly nine collision/surroundings component snapshots.");
        return false;
    }
    ...
    {
        OutError = TEXT("Hero-v4 migration changed the public-view scene actor transform or tags.");
        return false;
    }
    if (!SamePreservedState(
            ...
            false))
    {
        OutError = TEXT("Hero-v4 migration changed a hero-visual property other than its mesh/effective materials.");
        return false;
    }
    for (int32 Index = 0; Index < Expected.Components.Num(); ++Index)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("Hero-v4 migration changed preserved component '%s'."),
    ...
    {
        OutError = TEXT("Hero-v4 migration changed the camera actor count.");
        return false;
    }
    for (int32 Index = 0; Index < Expected.Cameras.Num(); ++Index)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("Hero-v4 migration changed preserved camera '%s'."),
    ...
    FString& OutError)
{
    ...
    {
        OutError = TEXT("Hero-v4 map does not reuse the exact v1 collision asset.");
        return false;
    }
    OutError.Reset();
    return true;
...
bool WriteMigrationInvariantReport(
    ...
    const FString& SourceV3Filename,
    const FString& SourceV3ShaBefore,
    const FString& SourceV3ShaAfter,
    int64 SourceV3Bytes,
    ...
    FString& OutError)
{
    if (ProtectedV1ShaBefore != ProtectedV1ShaAfter ||
        ...
        SourceV3ShaBefore != SourceV3ShaAfter ||
        !ValidateSurroundingsUnchanged(Baseline, Persisted, OutError))
    {
        if (OutError.IsEmpty())
        {
            OutError = TEXT("A protected V1/V2 map or the source V3 map SHA-256 changed during V4 migration.");
        }
        return false;
    }
    ...
    Root->SetStringField(
        TEXT("schema"),
        TEXT("triad.istana_public_view_hero_v4.component_invariants.v1"));
    ...
    Root->SetStringField(TEXT("sourceMapFilename"), SourceV3Filename);
    Root->SetStringField(TEXT("sourceMapSha256Before"), SourceV3ShaBefore);
    Root->SetStringField(TEXT("sourceMapSha256After"), SourceV3ShaAfter);
    Root->SetNumberField(TEXT("sourceMapBytes"), static_cast<double>(SourceV3Bytes));
    ...
    {
        OutError = TEXT("Could not serialize the hero-v4 invariant report.");
        return false;
    }
    OutReportPath = FPaths::ConvertRelativePathToFull(FPaths::Combine(
        FPaths::ProjectSavedDir(),
        TEXT("TRIAD/IstanaPublicViewV4/Istana_PublicView_Exterior_v4.invariants.json")));
    if (!IFileManager::Get().MakeDirectory(
        ...
        !FFileHelper::SaveStringToFile(
            ...
            *OutReportPath,
            FFileHelper::EEncodingOptions::ForceUTF8WithoutBOM))
    {
        OutError = TEXT("Could not persist the hero-v4 invariant report under Saved/TRIAD.");
        return false;
    }
    OutError.Reset();
    return true;
...
bool ValidateEffectiveHeroV4Materials(
    ...
    FString& OutError)
{
    ...
    {
        OutError = TEXT("V4 hero component has missing mesh, material overrides, or an overlay material.");
        return false;
    }
    ...
    {
        OutError = TEXT("V4 hero component does not expose exactly eleven effective materials.");
        return false;
    }
    for (int32 Index = 0; Index < StaticMaterials.Num(); ++Index)
    {
        ...
        {
            OutError = FString::Printf(
                TEXT("V4 hero effective material differs at slot '%s'."),
                *Slot);
            return false;
        }
    }
...
bool ValidateExactV3SourceHeroComponent(
    UStaticMeshComponent* HeroComponent,
    FString& OutError)
{
    if (!HeroComponent || !HeroComponent->GetStaticMesh() ||
        HeroComponent->GetStaticMesh()->GetPathName() != V3HeroMeshObjectPath ||
        HeroComponent->HasOverrideMaterials() ||
        HeroComponent->GetNumOverrideMaterials() != 0 ||
        HeroComponent->GetOverlayMaterial() != nullptr ||
        HeroComponent->GetCollisionEnabled() != ECollisionEnabled::NoCollision)
    {
        OutError = TEXT("V4 source must retain the exact non-colliding V3 hero visual without overrides or an overlay.");
        return false;
    }
    const TArray<FStaticMaterial>& StaticMaterials =
        HeroComponent->GetStaticMesh()->GetStaticMaterials();
    if (StaticMaterials.Num() != ExpectedV3SourceSlots().Num() ||
        HeroComponent->GetNumMaterials() != ExpectedV3SourceSlots().Num())
    {
        OutError = TEXT("V4 source V3 hero does not expose the exact eleven-slot material roster.");
        return false;
    }
    TSet<FString> SeenSlots;
    for (int32 Index = 0; Index < StaticMaterials.Num(); ++Index)
    {
        ...
        const FString ExpectedInstance =
            ExpectedV3SourceSlotMaterials().FindRef(Slot);
        ...
        // order. V3 canonicalized the exact semantic roster after import;
        // still validate by name at the effective physical index and never
        // reorder or otherwise mutate the protected V3 asset/map.
        if (!ExpectedV3SourceSlots().Contains(Slot) ||
            SeenSlots.Contains(Slot) ||
            ExpectedInstance.IsEmpty() || !Effective ||
            Effective->GetPathName() != V3MaterialObjectPath(ExpectedInstance))
        {
            OutError = FString::Printf(
                TEXT("V4 source V3 hero semantic material binding differs at imported index %d (slot '%s')."),
                Index,
                *Slot);
            return false;
        }
    ...
    if (SeenSlots.Num() != ExpectedV3SourceSlots().Num())
    {
        OutError = TEXT("V4 source V3 hero semantic material roster is incomplete.");
        return false;
    }
    OutError.Reset();
    return true;
    ...
    FString& OutReport)
{
    ...
    {
        OutReport = TEXT("HERO_V4_MAP_INVALID: exact V3 surroundings/camera baseline is required.");
        return false;
    }
    ...
    {
        OutReport = TEXT("HERO_V4_MAP_INVALID: exact non-colliding v4 hero visual is absent. ") + Error;
        return false;
    }
    if (!ValidateEffectiveHeroV4Materials(
            Scene->BuildingHeroVisualComponent, Error))
    {
        OutReport = TEXT("HERO_V4_MAP_INVALID: ") + Error;
        return false;
    }
    ...
    FString& OutError)
{
    ...
    {
        OutError = FString::Printf(
            TEXT("Open exact source map '%s' before v4 migration."),
            *SourceMapPackage);
        return false;
    }
    OutScene = FindOnlySceneActor(World, OutError);
    if (!OutScene ||
        !ValidateExactV3SourceHeroComponent(
...
void ConfigureHeroV4D65CaptureCamera(
...
bool HasHeroV4D65CaptureCamera(
...
class FScopedHeroV4TsrCaptureQuality final
{
public:
    ...
    ~FScopedHeroV4TsrCaptureQuality()
    {
        FString Ignored;
        Restore(Ignored);
    }
    ...
    FString& OutMessage)
{
    ...
    {
        OutMessage = TEXT("V4 migration requires the editor asset subsystem and validated hero.");
        return false;
    }
    ...
    {
        OutMessage = FString::Printf(
            TEXT("Refusing to overwrite existing v4 destination map '%s'."),
    ...
    FString Error;
    FString V3StructuralReport;
    if (!UTRIADIstanaPublicViewHeroV3EditorLibrary::
            ValidateIstanaPublicViewHeroV3Map(V3StructuralReport))
    {
        OutMessage = TEXT("V4_MIGRATION_REFUSED: exact V3 source validation failed. ") +
            V3StructuralReport;
        return false;
    }
    ...
    {
        OutMessage = TEXT("V4_MIGRATION_REFUSED: ") + Error;
        return false;
    }
    ...
    FString SourceV3Filename;
    FString SourceV3ShaBefore;
    int64 SourceV3BytesBefore = 0;
    if (!FPackageName::DoesPackageExist(
        ...
        !CalculateSha256(
            ...
            Error) ||
        !FPackageName::DoesPackageExist(SourceMapPackage, &SourceV3Filename) ||
        !CalculateSha256(
            SourceV3Filename,
            SourceV3ShaBefore,
            SourceV3BytesBefore,
            Error))
    {
        OutMessage = TEXT("V4_MIGRATION_REFUSED: could not freeze protected V1/V2 and source V3 map bytes before duplication. ") + Error;
        return false;
    }
    ...
    {
        OutMessage = TEXT("UNSAVED_PARTIAL_V4_MAP: could not create the isolated in-memory v4 map duplicate.");
        return false;
    }
    ...
    {
        OutMessage = TEXT("UNSAVED_PARTIAL_V4_MAP: duplicate did not preserve exact V3 surroundings. ") + Error;
        return false;
    }

    // This is intentionally the sole scene mutation in the v4 migration.
    ...
    if (!CaptureSurroundings(TargetScene, AfterSwap, Error) ||
        ...
        !ValidateWorldForV4(
            ...
            PreSaveReport))
    {
        OutMessage = TEXT("UNSAVED_PARTIAL_V4_MAP: hero-only pre-save validation failed. ") +
            (!Error.IsEmpty() ? Error : PreSaveReport);
        return false;
    }
    if (!AssetSubsystem->SaveLoadedAsset(TargetWorld, false))
    {
        OutMessage = TEXT("SAVE_FAILED_PARTIAL_V4_MAP: validated duplicate could not be saved. The V1/V2/V3 maps were not overwritten; inspect only the new V4 package before retrying.");
        return false;
    }
    ...
    {
        OutMessage = TEXT("V4 map save returned success but no destination package exists.");
        return false;
    }
    UWorld* Reloaded = UEditorLoadingAndSavingUtils::LoadMap(DestinationFilename);
    FString PersistedReport;
    if (!ValidateWorldForV4(
            Reloaded,
            DestinationMapPackage,
            &SourceSnapshot,
            PersistedReport))
    {
        OutMessage = TEXT("V4 destination saved but persistence validation failed: ") +
            PersistedReport;
        return false;
    }
    ...
    {
        OutMessage = TEXT("CRITICAL: a protected V1/V2 map or source V3 map disappeared during additive migration.");
        return false;
    }
    ...
    FString SourceV3ShaAfter;
    int64 SourceV3BytesAfter = 0;
    if (!CalculateSha256(
            ProtectedV1Filename,
            ProtectedV1ShaAfter,
        ...
        !CalculateSha256(
            ...
            SourceV3BytesAfter,
            Error) ||
        SourceV3BytesBefore != SourceV3BytesAfter ||
        SourceV3ShaBefore != SourceV3ShaAfter)
    {
        OutMessage = TEXT("CRITICAL: protected V1/V2 or source V3 map bytes changed during additive migration. ") + Error;
        return false;
    }
    ...
    {
        OutMessage = TEXT("V4 destination persistence snapshot failed: ") + Error;
        return false;
    }
    ...
    if (!WriteMigrationInvariantReport(
            ...
            Error))
    {
        OutMessage = TEXT("V4 destination saved but invariant report failed: ") + Error;
        return false;
    }
    OutMessage = FString::Printf(
        TEXT("Created non-overwriting %s from exact V3 and swapped only BuildingHeroVisualComponent to %s. %s Protected V1 retained SHA-256 %s, protected V2 retained SHA-256 %s, and source V3 retained SHA-256 %s; collision, terrain/hardscape/context/trees, and cameras remained exact. Invariant report: %s. Nanite, SM6, renderer, project settings, and sensor truth were unchanged."),
        *DestinationMapPackage,
        *HeroMeshObjectPath,
        *PersistedReport,
        *ProtectedV1ShaAfter,
...
bool UTRIADIstanaPublicViewHeroV4EditorLibrary::
        ...
        FString& OutReport)
{
    ...
    {
        OutReport = FString::Printf(
            TEXT("Hero-v4 Remote Control project mismatch: connected '%s', expected '%s'. No operation ran."),
            *ActualDirectory,
            *ExpectedDirectory);
        return false;
    }
    OutReport = TEXT("Hero-v4 Remote Control project identity verified: ") +
        ActualDirectory;
    return true;
}

bool UTRIADIstanaPublicViewHeroV4EditorLibrary::
    ImportIstanaPublicViewHeroV4Assets(FString& OutMessage)
{
    OutMessage.Reset();
    ...
    if (!ValidateCompleteV4SourceSet(
    ...
    return ImportHeroV4AssetSet(
        AssetSubsystem, Geometry, Materials, SourceReport, OutMessage);
}

bool UTRIADIstanaPublicViewHeroV4EditorLibrary::
    ValidateIstanaPublicViewHeroV4Assets(FString& OutReport)
{
    FHeroGeometryContract Geometry;
    FHeroMaterialPack Materials;
    FString SourceReport;
    ...
    if (InspectHeroV4Assets(
            ...
            Materials,
            nullptr,
            AssetReport) != EHeroV4AssetState::CompleteValid)
    {
...
bool UTRIADIstanaPublicViewHeroV4EditorLibrary::
    MigrateIstanaPublicViewExteriorMapToHeroV4(FString& OutMessage)
{
    OutMessage.Reset();
    if (!IsEditorOperationSafe(OutMessage))
    {
    ...
    return MigrateMapToV4(AssetSubsystem, Hero, OutMessage);
}

bool UTRIADIstanaPublicViewHeroV4EditorLibrary::
    ValidateIstanaPublicViewHeroV4Map(FString& OutReport)
{
    FHeroGeometryContract Geometry;
    FHeroMaterialPack Materials;
    FString SourceReport;
    if (!ValidateCompleteV4SourceSet(Geometry, Materials, SourceReport))
    {
        OutReport = SourceReport;
        return false;
    }
    ...
    if (InspectHeroV4Assets(
            ...
            AssetReport) != EHeroV4AssetState::CompleteValid)
    {
        OutReport = TEXT("HERO_V4_MAP_INVALID: source/assets are stale. ") + AssetReport;
        return false;
    }
    FString V3AssetReport;
    if (!UTRIADIstanaPublicViewHeroV3EditorLibrary::
            ValidateIstanaPublicViewHeroV3Assets(V3AssetReport))
    {
        OutReport = TEXT("HERO_V4_MAP_INVALID: the protected V3 source asset set is stale. ") +
            V3AssetReport;
        return false;
    }
    if (UPackage* LoadedSource = FindPackage(nullptr, *SourceMapPackage))
    {
        ...
        {
            OutReport = TEXT("HERO_V4_MAP_INVALID: loaded V3 source package is dirty; save/revert it before exact comparison.");
            return false;
        }
    }
    ...
    {
        OutReport = TEXT("HERO_V4_MAP_INVALID: exact V3 source could not be loaded. ") +
            BaselineError;
        return false;
    }
    ...
    OutReport = SourceReport + TEXT(" ") + AssetReport + TEXT(" ") +
        V3AssetReport + TEXT(" ") + MapReport;
    return true;
}

bool UTRIADIstanaPublicViewHeroV4EditorLibrary::
    ValidateIstanaPublicViewHeroV4PlayWorldReadiness(FString& OutReport)
{
    FString VisualProfileReport;
    if (!ValidateHeroV4VisualAcceptanceProcessProfile(VisualProfileReport))
    {
        OutReport = TEXT("Hero-V4 PIE readiness refuses an arbitrary sensor process profile. ") +
            VisualProfileReport;
        return false;
    }
    FString EditorStructuralReport;
    if (!ValidateIstanaPublicViewHeroV4Map(EditorStructuralReport))
    {
        OutReport = TEXT("Hero-V4 PIE readiness requires the exact validated V4 editor map. ") +
    ...
    {
        OutReport = TEXT("Start authoritative non-simulated PIE in Istana_PublicView_Exterior_v4 before Hero-V4 runtime validation.");
        return false;
    }
    ...
    {
        OutReport = FString::Printf(
            TEXT("Hero-V4 PIE source package is '%s', expected '%s'."),
            *PlaySourcePackage,
            *DestinationMapPackage);
        return false;
    }
    ...
    if (SceneCount != 1 || !Scene || !Scene->HasActorBegunPlay() ||
        ...
        !ValidateEffectiveHeroV4Materials(
            Scene ? Scene->BuildingHeroVisualComponent.Get() : nullptr,
            HeroError))
    {
        Errors.Add(FString::Printf(
            TEXT("Expected one begun exact Hero-V4 scene (count=%d). Scene='%s' Hero='%s'."),
            SceneCount,
            *RuntimeSceneReport,
            *HeroError));
    }
    ...
    {
        Errors.Add(TEXT("Hero-V4 PIE does not use the exact TRIAD AirSim GameMode wrapper."));
    }
    ...
    if (Errors.Num() > 0)
    {
        OutReport = TEXT("Hero-V4 PIE readiness failed:\n - ") +
            FString::Join(Errors, TEXT("\n - "));
        return false;
    }
    OutReport = FString::Printf(
        TEXT("Hero-V4 PIE readiness passed for '%s': exact no-lidar visual profile, editor-map preservation, V4 hero/material bindings, begun scene/policy, clear weather/fog, exact GameMode, and restored primary view are verified. Capture cameras and quality overrides remain transient only. %s"),
        *DestinationMapPackage,
        *VisualProfileReport);
    return true;
}
        ...
        FString& OutMessage)
{
    ...
    if (!ValidateIstanaPublicViewHeroV4PlayWorldReadiness(ReadinessReport))
    {
        OutMessage = TEXT("Hero-V4 quality capture requires settled PIE readiness. ") +
            ReadinessReport;
        return false;
    }
    ...
    if (OutputFileName.IsEmpty() || OutputFileName.Len() > 128 ||
        ...
        !OutputFileName.StartsWith(
            TEXT("ipv_v4_quality_"), ESearchCase::CaseSensitive) ||
        !OutputFileName.EndsWith(TEXT(".png"), ESearchCase::CaseSensitive))
    {
        OutMessage = TEXT("OutputFileName must be a leaf-only 'ipv_v4_quality_*.png' name of at most 128 characters.");
        return false;
    }
    ...
    if (!PlayWorld ||
        UWorld::RemovePIEPrefix(PlayWorld->GetOutermost()->GetName()) !=
            DestinationMapPackage)
    {
        OutMessage = TEXT("The active PIE world is not the exact Hero-V4 map.");
        return false;
    }
    ATRIADIstanaPublicViewSceneActor* Scene = nullptr;
    int32 SceneCount = 0;
    ...
    {
        OutMessage = TEXT("Another Unreal screenshot request is pending; no Hero-V4 capture was scheduled.");
        return false;
    }
    ...
    {
        OutMessage = FString::Printf(
            TEXT("Could not create isolated Hero-V4 capture directory '%s'."),
            *OutputDirectory);
        return false;
    }
    ...
    {
        OutMessage = TEXT("Could not spawn the transient Hero-V4 QA camera.");
        return false;
    }
    CaptureCamera->Tags.AddUnique(
        FName(TEXT("TRIADIstanaPublicViewHeroV4QualityCaptureOnly")));
    ConfigureHeroV4D65CaptureCamera(CaptureComponent, FieldOfView);
    if (!HasHeroV4D65CaptureCamera(CaptureComponent, FieldOfView))
    {
    ...
    if (Viewport->GetSizeXY() != FIntPoint(3840, 2160))
    {
        ...
        RestoreViewport();
        OutMessage = TEXT("PIE viewport rejected the exact 3840x2160 Hero-V4 QA size.");
        return false;
    }
        ...
        !FMath::IsNearlyEqual(CachedView.FOV, ExpectedView.FOV, 0.01f))
    {
        RestorePrimaryAndDestroy();
        RestoreViewport();
        OutMessage = TEXT("Player 0 cached POV did not match the transient Hero-V4 QA camera.");
        return false;
    }

    FScopedHeroV4TsrCaptureQuality Quality;
    ...
    if (!bRequestProcessed || !bFileWritten)
    {
        ...
        RestoreViewport();
        OutMessage = FString::Printf(
            TEXT("Hero-V4 synchronous QA capture failed for '%s' (requestProcessed=%s, fileBytes=%lld, qualityRestored=%s). %s"),
            *Preset,
    ...
    const bool bRuntimeRestored =
        ValidateIstanaPublicViewHeroV4PlayWorldReadiness(RestoredReadiness);
    if (!bQualityRestored || !bRuntimeRestored)
    {
        OutMessage = FString::Printf(
            TEXT("Hero-V4 image '%s' was written, but transient-state restoration failed (quality=%s, runtime=%s). Quality='%s' Runtime='%s'."),
            *DestinationPath,
            bQualityRestored ? TEXT("true") : TEXT("false"),
...
bool UTRIADIstanaPublicViewHeroV4EditorLibrary::
    QuiesceIstanaPublicViewHeroV4PlayWorldForStop(FString& OutMessage)
{
    OutMessage.Reset();
    UWorld* PlayWorld = GEditor ? GEditor->PlayWorld : nullptr;
    if (!PlayWorld || PlayWorld->WorldType != EWorldType::PIE)
    {
        OutMessage = TEXT("No Hero-V4 PIE PlayWorld exists to quiesce.");
        return false;
    }
    ...
    {
        OutMessage = FString::Printf(
            TEXT("Refusing Hero-V4 quiescence for PIE source '%s'; expected '%s'."),
            *SourcePackage,
            *DestinationMapPackage);
        return false;
    }
    ...
    {
        OutMessage = FString::Printf(
            TEXT("Exact Hero-V4 PIE identity failed before quiescence: policy=%d scene=%d gameMode='%s'. PIE was not stopped."),
            PolicyCount,
            SceneCount,
            ActiveGameMode
                ? *ActiveGameMode->GetClass()->GetPathName()
    ...
    {
        OutMessage = FString::Printf(
            TEXT("Hero-V4 AirSim quiescence failed for %d discovered simulation mode(s); PIE was not stopped."),
            SimModeCount);
        return false;
    }
    OutMessage = FString::Printf(
        TEXT("Hero-V4 PIE is quiescent: exact V4 world/policy/scene/GameMode identity passed and %d AirSim simulation mode(s) are paused. No map or asset was saved."),
        SimModeCount);
    return true;
}
