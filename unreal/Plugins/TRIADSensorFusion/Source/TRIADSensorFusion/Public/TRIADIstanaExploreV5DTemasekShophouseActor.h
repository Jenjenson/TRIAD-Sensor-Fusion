...
#include "TRIADIstanaExploreV5DTemasekShophouseActor.generated.h"
...
/**
 * Dedicated R24B Temasek Shophouse public-exterior renderer.
 *
 ...
 */
UCLASS()
class TRIADSENSORFUSION_API ATRIADIstanaExploreV5DTemasekShophouseActor
    : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    bool ConfigureTemasekShophouse(
        UStaticMesh* Mesh,
    ...
    bool ValidateTemasekShophouse(FString& OutReport) const;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "TRIAD|Istana Explore V5D|Temasek Shophouse")
    UStaticMeshComponent* DedicatedRenderOnlyComponent = nullptr;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "TRIAD|Istana Explore V5D|Temasek Shophouse|Composition")
    ...
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "TRIAD|Istana Explore V5D|Temasek Shophouse|Composition")
    bool bCoarseShellOverlapResolved = false;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "TRIAD|Istana Explore V5D|Temasek Shophouse|Composition")
    bool bProviderOverlapResolved = false;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "TRIAD|Istana Explore V5D|Temasek Shophouse|Truth")
    ...
    UPROPERTY(Transient, VisibleAnywhere, BlueprintReadOnly, Category = "TRIAD|Istana Explore V5D|Temasek Shophouse|Runtime")
