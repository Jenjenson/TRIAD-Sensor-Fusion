...
void UTRIADIstanaExploreV5DTemasekShophouseProvenance::
    SetCanonicalContract(const FString& InCookedRenderPayloadSha256)
{
    SourceOutputSetSha256 =
        TEXT("0ACA9941B8C60766EA4647A991DF80944B4A746E06CC2A5680C2D167C0FA4A4D");
    RenderObjSha256 =
        TEXT("F5ED94C312A38A542D9C078F19F16FAF04CEA6ECAE5B4C2CF0AA7F3D651B9007");
    CanonicalGeometrySha256 =
        TEXT("CC40E8C2C975D2A19124D74EAAC80B6C14C7121AD6BDDD616A740620737B05A7");
    PlacementReceiptSha256 =
        TEXT("6BEA0091D68FB0202A759733AB2838AA0A4405783D38EE1420A9E4CC090014A5");
    OSMFeatureGeometrySha256 =
        TEXT("A273E09B21C71AA7436C5B156E643AF4176F3B90A215DD0FEA56928FA5BDDEF7");
    OSMPartGeometrySha256 =
        TEXT("EBEF89D86FF0BA7FD6DBF188ED2389CC392E2E859ACEEADF6F0900E6E880E928");
    FoliageLayoutSchema =
    ...
    FoliageSourcePlacementTransform =
        ATRIADIstanaExploreV5DLandmarkVegetationActor::
    ...
    bFoliageRenderedByLandmarkVegetationActor = true;
...
bool UTRIADIstanaExploreV5DTemasekShophouseProvenance::
    ...
    IsCanonicalContract() const
{
    return SourceOutputSetSha256 ==
        ...
        FoliageRenderOwnerClass ==
            ATRIADIstanaExploreV5DLandmarkVegetationActor::
                ExpectedTemasekFoliageRenderOwnerClass() &&
        FoliageSourcePlacementTransform.Equals(
            ATRIADIstanaExploreV5DLandmarkVegetationActor::
                ExpectedTemasekSourcePlacementTransform(),
            0.000001) &&
        FoliageTreeAnchorsLocalMeters ==
        ...
        Components == 828 && SourceVertices == 9536 && Triangles == 15760 &&
        MaterialSlots == 15 && bProceduralTextureFreePbrPresentation &&
